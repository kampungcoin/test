...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizePrufus = new QSpinBox(tabMain);
        anonymizePrufus->setObjectName(QStringLiteral("anonymizePrufus"));
        anonymizePrufus->setMinimum(100);
        anonymizePrufus->setMaximum(100000);
        anonymizePrufus->setSingleStep(100);
        anonymizePrufus->setValue(1000);

        horizontalLayout->addWidget(anonymizePrufus);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start PRUFUS after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start PRUFUS on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of PRUFUS to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the PRUFUS client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the PRUFUS network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting PRUFUS.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/Prufus-project/Prufus-project-translations", 0));
