...
public:
    CMainParams()
    {
        ...
        nStartMasternodePayments = 1521364103;
    }
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 135); // Testnet Prufus addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 25);  // Testnet Prufus script addresses start with '8' or '9'
        ...
        strSporkKey = "040298f74bed61f1e0b5a6211b1f387f8f1ada1ca58aabe047fc2d62af53304ef38389d1bb0614eaeeb72a4a8fc3015317e45570ef06e8c66471ddf8651c80b292";
        strObfuscationPoolDummyAddress = "FHoujpfmyWqr69iWhv8D5kpenvSYwG1MGm";
        nStartMasternodePayments = 1521364105; 
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
